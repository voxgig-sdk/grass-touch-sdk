...
func registerSDKWords(r *eng.Registry, client *sdk.GrassTouchSDK) {
...
func runOp(client *sdk.GrassTouchSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
