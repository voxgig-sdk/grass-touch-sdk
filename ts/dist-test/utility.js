...
function envOverride(m) {
    if ('TRUE' === process.env.GRASS_TOUCH_TEST_LIVE ||
        'TRUE' === process.env.GRASS_TOUCH_TEST_OVERRIDE) {
    ...
    m.GRASS_TOUCH_TEST_EXPLAIN = process.env.GRASS_TOUCH_TEST_EXPLAIN || m.GRASS_TOUCH_TEST_EXPLAIN;
    return m;
}
