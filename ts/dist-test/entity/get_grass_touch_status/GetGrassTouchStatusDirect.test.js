...
(0, node_test_1.describe)('GetGrassTouchStatusDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.GrassTouchSDK({
    ...
    (0, node_test_1.test)('direct-load-get_grass_touch_status', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-get_grass_touch_status', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.GRASS_TOUCH_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.GrassTouchSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['GRASS_TOUCH_TEST_GET_GRASS_TOUCH_STATUS_ENTID'];
    ...
    const client = new __1.GrassTouchSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=GetGrassTouchStatusDirect.test.js.map