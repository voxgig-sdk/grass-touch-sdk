...
|---|---|---|
| `ts/` | @voxgig-sdk/grass-touch-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/grass-touch-sdk \
      --repository voxgig-sdk/grass-touch-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/grass-touch-sdk` shows it, and
`npm trust revoke @voxgig-sdk/grass-touch-sdk --id=<id>` removes it.
