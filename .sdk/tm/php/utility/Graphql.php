...
// GrassTouch SDK utility: graphql
//
...
class GrassTouchGraphql
{
    ...
    // equivalent.
    public static function body(GrassTouchContext $ctx): mixed
    {
    ...
    public static function errors(GrassTouchContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
