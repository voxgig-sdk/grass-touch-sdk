...
// GrassTouch SDK utility: fetcher

class GrassTouchFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; GrassTouchSDK/1.0)';
    ...
    public static function call(GrassTouchContext $ctx, string $fullurl, array $fetchdef): array
    {
