...
// GrassTouch SDK idempotency feature
...
class GrassTouchIdempotencyFeature extends GrassTouchBaseFeature
{
    ...
    private function _mutating(GrassTouchContext $ctx): bool
    {
