...
class GrassTouchNetsimFeature extends GrassTouchBaseFeature
{
    ...
    private function _simulate(GrassTouchContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(GrassTouchContext $ctx, array $applied): void
    {
        $client = $this->client;
