...
// GrassTouch SDK timeout feature
...
class GrassTouchTimeoutFeature extends GrassTouchBaseFeature
{
    ...
    private function _with_timeout(GrassTouchContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(GrassTouchContext $_ctx, float $ms): void
    {
        $client = $this->client;
