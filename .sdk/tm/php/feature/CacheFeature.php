...
class GrassTouchCacheFeature extends GrassTouchBaseFeature
{
    ...
    private function _through(GrassTouchContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
