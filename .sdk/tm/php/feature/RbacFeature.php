...
class GrassTouchRbacFeature extends GrassTouchBaseFeature
{
    ...
    private function _required(GrassTouchContext $ctx): ?string
    {
    ...
    private function _reject(GrassTouchContext $ctx, string $required): void
    {
    ...
    private function _track(GrassTouchContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
