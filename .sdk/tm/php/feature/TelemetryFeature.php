...
// GrassTouch SDK telemetry feature
...
class GrassTouchTelemetryFeature extends GrassTouchBaseFeature
{
    ...
    private function _close(GrassTouchContext $ctx, bool $ok): void
    {
