...
class GrassTouchTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = GrassTouchTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = GrassTouchTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = GrassTouchTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
