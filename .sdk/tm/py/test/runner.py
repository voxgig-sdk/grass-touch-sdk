...
class GrassTouchTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = GrassTouchTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = GrassTouchTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = GrassTouchTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
