...
_runner = makeRunner(TEST_JSON_FILE, GrassTouchSDK.test(None, None))
...
class TestPrimaryUtility:
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = GrassTouchSDK.test(None, setup.get('a') or {})
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = GrassTouchSDK.test(None, setup.get('a') or {})
