# GrassTouch PHP SDK Reference

Complete API reference for the GrassTouch PHP SDK.
...
#### `GrassTouchSDK::test($testopts = null, $sdkopts = null)`
...
#### `make(): GetGrassTouchStatusEntity`
