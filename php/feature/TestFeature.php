...
// GrassTouch SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class GrassTouchTestFeature extends GrassTouchBaseFeature
{
    ...
    public function init(GrassTouchContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (GrassTouchContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = GrassTouchParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (GrassTouchContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(GrassTouchContext $ctx, $op, $args): array
    {
