...
class GrassTouchProxyFeature extends GrassTouchBaseFeature
{
    ...
    public function init(GrassTouchContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (GrassTouchContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
