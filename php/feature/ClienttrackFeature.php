...
// GrassTouch SDK clienttrack feature
...
class GrassTouchClienttrackFeature extends GrassTouchBaseFeature
{
    ...
    public function PostConstruct(GrassTouchContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'GrassTouch-SDK';
