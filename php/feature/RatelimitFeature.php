...
// GrassTouch SDK ratelimit feature
...
class GrassTouchRatelimitFeature extends GrassTouchBaseFeature
{
    ...
    private function _acquire(GrassTouchContext $ctx): void
    {
    ...
    private function _track(GrassTouchContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
