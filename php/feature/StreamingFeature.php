...
// GrassTouch SDK streaming feature
...
class GrassTouchStreamingFeature extends GrassTouchBaseFeature
{
    ...
    private function _iterate(GrassTouchResult $result): \Generator
    {
    ...
    private function _streamable(GrassTouchContext $ctx): bool
    {
