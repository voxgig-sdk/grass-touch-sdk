...
// GrassTouch SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (GrassTouchSDK::test)
...
{
    private const SDK_CLASS = 'GrassTouchSDK';
    ...
    private const SDK_BASE = 'grasstouch_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../grasstouch_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
