...
// GrassTouch SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = GrassTouchOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(GrassTouchOmni::structfix($now, Struct::undef()))
                        !== json_encode(GrassTouchOmni::structfix($val, Struct::undef()))) {
