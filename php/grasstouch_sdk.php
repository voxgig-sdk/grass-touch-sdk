...
class GrassTouchSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = GrassTouchHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = GrassTouchHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!GrassTouchFeatures::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, GrassTouchFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return GrassTouchUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = GrassTouchHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = GrassTouchHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = GrassTouchHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new GrassTouchError($op . "_allow",
                "GrassTouchSDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = GrassTouchHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new GrassTouchError("graphql_error",
                "GrassTouchSDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function GetGrassTouchStatus($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_get_grass_touch_status === null) {
                $this->_get_grass_touch_status = new GetGrassTouchStatusEntity($this, null);
            }
            return $this->_get_grass_touch_status;
        }
        return new GetGrassTouchStatusEntity($this, $data);
    }
