// Command GrassTouch-mcp is an MCP server exposing the GrassTouch
// SDK as MCP tools.
//
// Two tools are registered:
//
//	GrassTouch_list  — list records of an entity
//	GrassTouch_load  — load a single record of an entity
//
