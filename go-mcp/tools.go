...
type Args struct {
	Entity string         `json:"entity" jsonschema:"get_grass_touch_status"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.GrassTouchSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "grass-touch_list",
		Description: "List records from GrassTouch. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "grass-touch_load",
		Description: "Load a single record from GrassTouch. " +
...
func runOp(client *sdk.GrassTouchSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.GrassTouchSDK, name string) (sdk.GrassTouchEntity, error) {
	switch strings.ToLower(name) {
	case "get_grass_touch_status":
		return client.GetGrassTouchStatus(nil), nil
