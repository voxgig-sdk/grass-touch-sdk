...
local GetGrassTouchStatusEntity = {}
GetGrassTouchStatusEntity.__index = GetGrassTouchStatusEntity


function GetGrassTouchStatusEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, GetGrassTouchStatusEntity)
  self._name = "get_grass_touch_status"
  self._client = client
...
function GetGrassTouchStatusEntity:get_name()
  return self._name
end


function GetGrassTouchStatusEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return GetGrassTouchStatusEntity.new(self._client, opts)
end
...
function GetGrassTouchStatusEntity:mark_deleted()
  self._deleted = true
end


function GetGrassTouchStatusEntity:deleted()
  return true == self._deleted
end


function GetGrassTouchStatusEntity:data_set(args)
  if args ~= nil then
...
function GetGrassTouchStatusEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function GetGrassTouchStatusEntity:match_set(args)
  if args ~= nil then
...
function GetGrassTouchStatusEntity:match_get()
...
function GetGrassTouchStatusEntity:stream(action, args, callopts)
...
function GetGrassTouchStatusEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return GetGrassTouchStatusEntity
