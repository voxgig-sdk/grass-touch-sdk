...
function runner.env_override(m)
  local live = runner.getenv("GRASS_TOUCH_TEST_LIVE")
  local override = runner.getenv("GRASS_TOUCH_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("GRASS_TOUCH_TEST_EXPLAIN")
