...
describe("GetGrassTouchStatusDirect", function()
  it("should direct-load-get_grass_touch_status", function()
    local setup = get_grass_touch_status_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-get_grass_touch_status", setup.live and "live" or "unit")
...
function get_grass_touch_status_direct_setup(mockres)
