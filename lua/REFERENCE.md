# GrassTouch Lua SDK Reference

Complete API reference for the GrassTouch Lua SDK.
...
```lua
local result, err = client:GetGrassTouchStatus(nil):load({ id = "get_grass_touch_status_id" }, nil)
```
