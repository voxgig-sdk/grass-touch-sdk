# GrassTouch SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions GrassTouchSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both GrassTouchSDK(...) and GrassTouchSDK.test(...) become
#      GrassTouchSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "grasstouch_sdk"
_SDK_CLASS = "GrassTouchSDK"
...
_ENTITIES = {
    "GetGrassTouchStatus": "get_grass_touch_status",
}
