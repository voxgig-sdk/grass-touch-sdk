...
class GrassTouchTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = GrassTouchTestRunner.getenv("GRASSTOUCH_TEST_LIVE")
        override = GrassTouchTestRunner.getenv("GRASSTOUCH_TEST_OVERRIDE")
        ...
        explain = GrassTouchTestRunner.getenv("GRASSTOUCH_TEST_EXPLAIN")
