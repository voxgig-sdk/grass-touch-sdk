...
from grasstouch_sdk.core.helpers import get_ctx_prop, to_map
...
class GrassTouchContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, GrassTouchSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, GrassTouchResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, GrassTouchResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return GrassTouchError(code, msg, self)
