...
from grasstouch_sdk.grasstouch_types import (
    GetGrassTouchStatus,
    GetGrassTouchStatusLoadMatch,
)
...
class GetGrassTouchStatusEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return GetGrassTouchStatusEntity(self._client, opts)
    ...
    def data_get(self) -> GetGrassTouchStatus:
    ...
    def match_get(self) -> GetGrassTouchStatus:
    ...
    def load(self, reqmatch=None, ctrl=None) -> GetGrassTouchStatus:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.GetGrassTouchStatus().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
