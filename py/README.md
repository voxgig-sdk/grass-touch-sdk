...
The SDK exposes the API as capitalised, semantic **Entities** — for example `client.GetGrassTouchStatus()` — each
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/grass-touch-sdk/releases)) or
...
| --- | --- | --- |
| `lastSeen` | `str` | Timestamp of the last known status update in ISO 8601 format |
| `message` | `str` | A message providing context or commentary about Kim's current outdoor activity status |
...
```
py/
├── grasstouch_sdk.py         -- Main SDK module
