...
func TestGetGrassTouchStatusEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		getGrassTouchStatusRef01DataRaw := vs.Items(core.ToMapAny(vs.GetPath(setup.data, "existing.get_grass_touch_status")))
...
func get_grass_touch_statusBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("GRASS_TOUCH_TEST_GET_GRASS_TOUCH_STATUS_ENTID")
	...
	idmapResolved := core.ToMapAny(env["GRASS_TOUCH_TEST_GET_GRASS_TOUCH_STATUS_ENTID"])
