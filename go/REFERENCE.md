# GrassTouch Golang SDK Reference

Complete API reference for the GrassTouch Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *GrassTouchSDK`
...
#### `GetGrassTouchStatus(data map[string]any) GrassTouchEntity`
