...
func (sdk *GrassTouchSDK) OptionsMap() map[string]any {
...
func (sdk *GrassTouchSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *GrassTouchSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *GrassTouchSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *GrassTouchSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *GrassTouchSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath(sdk.options, []any{"allow", "op"}).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *GrassTouchSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath(sdk.options, []any{"allow", "op"}).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("GrassTouchSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *GrassTouchSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *GrassTouchSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("GrassTouchSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
