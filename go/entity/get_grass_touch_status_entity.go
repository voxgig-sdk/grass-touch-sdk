...
type GetGrassTouchStatusEntity struct {
	name    string
	client  *core.GrassTouchSDK
...
func NewGetGrassTouchStatusEntity(client *core.GrassTouchSDK, entopts map[string]any) *GetGrassTouchStatusEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GetGrassTouchStatusEntity) GetName() string { return e.name }
...
func (e *GetGrassTouchStatusEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *GetGrassTouchStatusEntity) Deleted() bool {
	return e.deleted
}


func (e *GetGrassTouchStatusEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGetGrassTouchStatusEntity(e.client, opts)
}

func (e *GetGrassTouchStatusEntity) Data(args ...any) any {
...
func (e *GetGrassTouchStatusEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *GetGrassTouchStatusEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *GetGrassTouchStatusEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *GetGrassTouchStatusEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *GetGrassTouchStatusEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *GetGrassTouchStatusEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *GetGrassTouchStatusEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
