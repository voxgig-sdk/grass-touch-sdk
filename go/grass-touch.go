...
import (
	...
	"github.com/voxgig-sdk/grass-touch-sdk/go/entity"
	"github.com/voxgig-sdk/grass-touch-sdk/go/feature"
	_ "github.com/voxgig-sdk/grass-touch-sdk/go/utility"
)
...
// instead of `sdk.NewGrassTouchSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *GrassTouchSDK  { return NewGrassTouchSDK(nil) }
func Test() *GrassTouchSDK { return TestSDK(nil, nil) }
